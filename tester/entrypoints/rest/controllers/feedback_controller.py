...
def feedback_sd_current_account(sd_reference_id,body):  # noqa: E501
    """Capturing feedback against the SDCurrentAccount service that can target different levels of detail: SD/CR/BQ

    Capturing feedback against the SDCurrentAccount service that can target different levels of detail: SD/CR/BQ # noqa: E501
    ...
    method_id = "feedback_sd_current_account"
