...
class Config(object):
    ...
    API_VERSION = '{}'.format(tester.__version__)
    ...
    # @TODO load conf data for saga managment
    ...
    ############################################################################################
    ISOLATION_LEVEL = env.str('ISOLATION_LEVEL',default="SERIALIZABLE") # SERIALIZABLE
    ...
    # @TODO enable if RADIS implemented
    REDIS_URI = None # get_redis_host_and_port()
