...
class ExchangeControllerHandler_exchange_current_account_fulfillment_arrangement_account_lien_update(AbsBianCommandHandler):
...
class ExchangeControllerHandler_exchange_current_account_fulfillment_arrangement_payments_update(AbsBianCommandHandler):
    bian_action = ActionTerms.EXCHANGE
