...
class SDCurrentAccountFeedbackInputModel(Model):
    ...
    def __init__(self, service_domain_feedback_action_task_record=None, service_domain_feedback_action_record=None):  # noqa: E501
        """SDCurrentAccountFeedbackInputModel - a model defined in OpenAPI

        :param service_domain_feedback_action_task_record: The service_domain_feedback_action_task_record of this SDCurrentAccountFeedbackInputModel.  # noqa: E501
        :type service_domain_feedback_action_task_record: object
        :param service_domain_feedback_action_record: The service_domain_feedback_action_record of this SDCurrentAccountFeedbackInputModel.  # noqa: E501
    ...
    @classmethod
    def from_dict(cls, dikt) -> 'SDCurrentAccountFeedbackInputModel':
        """Returns the dict as a model

        :param dikt: A dict.
        :type: dict
        :return: The SDCurrentAccountFeedbackInputModel of this SDCurrentAccountFeedbackInputModel.  # noqa: E501
        :rtype: SDCurrentAccountFeedbackInputModel
        """
        return util.deserialize_model(dikt, cls)

    @property
    def service_domain_feedback_action_task_record(self):
        """Gets the service_domain_feedback_action_task_record of this SDCurrentAccountFeedbackInputModel.
        ...
        :return: The service_domain_feedback_action_task_record of this SDCurrentAccountFeedbackInputModel.
        :rtype: object
        """
    ...
    def service_domain_feedback_action_task_record(self, service_domain_feedback_action_task_record):
        """Sets the service_domain_feedback_action_task_record of this SDCurrentAccountFeedbackInputModel.

        `status: Not Mapped`  core-data-type-reference: BIAN::DataTypesLibrary::CoreDataTypes::UNCEFACT::Binary  general-info: The feedback service call consolidated processing record   # noqa: E501

        :param service_domain_feedback_action_task_record: The service_domain_feedback_action_task_record of this SDCurrentAccountFeedbackInputModel.
        :type service_domain_feedback_action_task_record: object
        """
    ...
    def service_domain_feedback_action_record(self):
        """Gets the service_domain_feedback_action_record of this SDCurrentAccountFeedbackInputModel.


        :return: The service_domain_feedback_action_record of this SDCurrentAccountFeedbackInputModel.
    ...
    def service_domain_feedback_action_record(self, service_domain_feedback_action_record):
        """Sets the service_domain_feedback_action_record of this SDCurrentAccountFeedbackInputModel.


        :param service_domain_feedback_action_record: The service_domain_feedback_action_record of this SDCurrentAccountFeedbackInputModel.
        :type service_domain_feedback_action_record: CurrentAccountSdReferenceIdFeedbackServiceDomainFeedbackActionRecord
        """
